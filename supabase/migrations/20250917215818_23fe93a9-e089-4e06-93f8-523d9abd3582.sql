...
-- Drop views in correct order (dependent first)
DROP VIEW IF EXISTS public.featured_creators_with_stats CASCADE;
DROP VIEW IF EXISTS public.safe_profiles CASCADE;

-- Create secure functions that return only safe profile data
